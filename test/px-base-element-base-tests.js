...
function runBaseTests() {
  px_base_element_1 = document.getElementById('px_base_element_1');

  suite('Base Automation Tests for px-base-element', function() {

    test('Polymer exists', function() {
      assert.isTrue(Polymer !== null);
    });
    test('px-base-element fixture is created', function() {
      assert.isTrue(document.getElementById('px_base_element_1') !== null);
    });
